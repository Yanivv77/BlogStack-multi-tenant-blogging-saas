...
export function SimpleIcon({ 
  ...
  const containerStyle = {
    width: size,
    height: size,
    color: color || brandColors[name] || 'currentColor'
  };
