...
export const PricingPlans: iAppProps[] = [
  {
    ...
    benefits: ["1 Site", "Up to 1000 Visitors", "Up to 1000 Visitors", "Up to 1000 Visitors"],
    priceTitle: "Free",
  },
  {
    id: 1,
    ...
    priceTitle: "$29",
    benefits: ["Unlimited Sites", "Unimlited Visitors", "Unimlited Visitors", "Unimlited Visitors"],
  },
];
