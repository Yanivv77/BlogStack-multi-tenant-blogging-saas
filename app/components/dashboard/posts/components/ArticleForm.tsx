...
export function ArticleForm({
  ...
  return (
    <Card>
      ...
      <CardContent>
        <form className="flex flex-col gap-6" id={form.id} onSubmit={handleFormSubmit}>
          ...
          <div className="grid gap-2">
            ...
            {fields.title.errors && (
              <p id="article-title-error" className="text-sm text-red-500">
                {fields.title.errors}
              </p>
            )}
          </div>
          ...
          <div className="grid gap-2">
            ...
            >
              <SimpleIcon name="atom" className="mr-2 size-4" aria-hidden="true" /> Generate Slug
            </Button>
          </div>
          ...
          <div className="grid gap-2">
            ...
            {fields.smallDescription.errors && (
              <p id="article-description-error" className="text-sm text-red-500">
                {fields.smallDescription.errors}
              </p>
            )}
          </div>
